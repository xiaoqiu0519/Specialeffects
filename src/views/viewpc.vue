  ...
  <div class="home">
    ...
    <div class="bg-1">
      ...
      <img
        class="conimg"
        @click="gotoabout()"
        v-else-if="languagetype == 2"
        src="../assets/auout_us_en.png"
        alt
        srcset
      />
      <img
        class="conimg"
        @click="gotoabout()"
        v-else-if="languagetype == 3"
        src="../assets/auout_us_jp.png"
        alt
        srcset
      />
    </div>
    ...
    return {
      ...
      Partner: {
        ...
        3: {
          title: "我々のパートナー",
          con:
            "LACRAEはすべての主要なオンラインとオフラインの販売ルートとマーケティングプ",
